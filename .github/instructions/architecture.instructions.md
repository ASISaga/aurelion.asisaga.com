...
- **Genesis Ontological Design System:** This subdomain uses the Genesis Ontological Design System from the theme repository. All SCSS must use semantic ontology mixins exclusively - zero raw CSS properties allowed.
- **Theme coordination (overview):** Changes that affect shared ontology mixins, design tokens, or build-time behavior typically require coordinated PRs across the theme and subdomain repositories.
...
- `.github/instructions/scss.instructions.md` — Genesis Ontological Design System usage, semantic mixins, zero raw CSS policy, and ontology categories.
...
- **Ontological Design System:** This subdomain follows the Genesis Ontological Design System with zero raw CSS properties. All styling comes from semantic mixins provided by the theme.
- For breaking changes to ontology mixins, design tokens, or shared components: create a coordination issue, link PRs across theme and subdomain repos, and assign reviewers from both teams.
- Prefer additive changes in the theme (new mixins/tokens) and deprecate old patterns gradually with a clear migration path.
